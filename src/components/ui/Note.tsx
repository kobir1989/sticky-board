          ...
          <div className="flex gap-1">
            {DEFAULT_COLORS.map((color) => (
              <div
                ...
                className={`relative h-4 w-4 cursor-pointer rounded-full border-2 border-white ${color.background} ${color.id === note.color.id ? 'ring-1 ring-blue-400 ring-offset-1' : ''} `}
              />
            ))}
          </div>
        </div>
